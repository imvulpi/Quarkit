...
{
	// Add this temporarily inside lzma2_encoder.c's init function:
	printf("Dict Size: %u, LC: %u, LP: %u, PB: %u\n", 
	((lzma_options_lzma*)filters[0].options)->dict_size,
	((lzma_options_lzma*)filters[0].options)->lc,
	((lzma_options_lzma*)filters[0].options)->lp,
	((lzma_options_lzma*)filters[0].options)->pb);
